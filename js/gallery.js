...
const GALLERY = [
  {
    ...
    src: frame(2),
    thumb: frame(2),
    alt: "Dr. Anneke van Dijk speaking on stage at the opening keynote, 2025",
    caption: "Dr. Anneke van Dijk opens with the Global yield model",
    year: 2025,
    category: "Keynotes",
    w: 4,
    h: 5,
  ...
  },
  {
    ...
    src: frame(5),
    thumb: frame(5),
    alt: "RoboPick's autonomous harvesting arm demonstrated to a crowd on the exhibition floor, 2025",
    caption: "RoboPick's harvesting arm draws a crowd on the floor",
    year: 2025,
    category: "Exhibition",
    w: 1,
    h: 1,
  },
  {
    ...
    src: frame(8),
    thumb: frame(8),
    alt: "Attendees mixing substrate by hand at a hands-on workshop table, 2025",
    caption: "Hands-on substrate mixing, table by table",
    year: 2025,
    category: "Workshops",
    w: 16,
    h: 9,
  },
  {
    ...
    src: frame(11),
    thumb: frame(11),
    alt: "A first-time exhibitor accepting the Highest Yield award on stage, 2025",
    caption: "Highest Yield goes to a first-time exhibitor",
    year: 2025,
    category: "Awards",
    w: 3,
    h: 4,
  },
  {
    ...
    src: frame(14),
    thumb: frame(14),
    alt: "Buyers and growers talking on the terrace during the evening networking session, 2025",
    caption: "Buyer–grower matchmaking on the terrace",
    year: 2025,
    category: "Networking",
    w: 5,
    h: 4,
  },
  {
    ...
    src: frame(17),
    thumb: frame(17),
    alt: "A panel of cold-chain experts answering audience questions, 2025",
    caption: "Cold-chain panel runs twenty minutes over",
    year: 2025,
    category: "Keynotes",
    w: 9,
    h: 16,
  },
  {
    ...
    src: frame(20),
    thumb: frame(20),
    alt: "A grower testing a climate sensor display at the ClimaGrow exhibition booth, 2025",
    caption: "A grower tests sensors at the ClimaGrow booth",
    year: 2025,
    category: "Exhibition",
    w: 16,
    h: 10,
  ...
  },
  {
    ...
    src: frame(23),
    thumb: frame(23),
    alt: "Workshop participants inspecting a substrate sample under light, 2025",
    caption: "Checking colonisation under the inspection lamp",
    year: 2025,
    category: "Workshops",
    w: 4,
    h: 3,
  },
  {
    ...
    src: frame(26),
    thumb: frame(26),
    alt: "The full Grower Awards stage line-up applauding winners, 2025",
    caption: "The full Grower Awards line-up, 2025",
    year: 2025,
    category: "Awards",
    w: 2,
    h: 3,
...

  {
    ...
    src: frame(29),
    thumb: frame(29),
    alt: "Prof. S. Iyer presenting substrate science research to a packed hall, 2024",
    caption: "Standing room only for the substrate science keynote",
    year: 2024,
    category: "Keynotes",
    w: 4,
    h: 5,
  },
  {
    ...
    src: frame(32),
    thumb: frame(32),
    alt: "Rows of compost and packaging suppliers along the exhibition hall, 2024",
    caption: "Compost suppliers line the exhibition hall",
    year: 2024,
    category: "Exhibition",
    w: 1,
    h: 1,
  },
  {
    ...
    src: frame(35),
    thumb: frame(35),
    alt: "A cold-chain logistics workshop running past its scheduled end time, 2024",
    caption: "Cold-chain workshop runs past closing time",
    year: 2024,
    category: "Workshops",
    w: 16,
    h: 9,
  ...
  },
  {
    ...
    src: frame(38),
    thumb: frame(38),
    alt: "Winners holding the Grower Awards trophy on stage, mid-applause, 2024",
    caption: "The Grower Awards stage, mid-applause",
    year: 2024,
    category: "Awards",
    w: 3,
    h: 4,
  },
  {
    ...
    src: frame(3),
    thumb: frame(3),
    alt: "Attendees networking on the lawn outside the venue after dark, 2024",
    caption: "Evening networking spills onto the lawn",
    year: 2024,
    category: "Networking",
    w: 5,
    h: 4,
  },
  {
    ...
    src: frame(6),
    thumb: frame(6),
    alt: "Lars Bakker demonstrating RoboPick controls during a technical keynote, 2024",
    caption: "Lars Bakker walks through the RoboPick controls",
    year: 2024,
    category: "Keynotes",
    w: 9,
    h: 16,
  },
  {
    ...
    src: frame(9),
    thumb: frame(9),
    alt: "A visitor examining packaged mushrooms at an export-readiness exhibition stand, 2024",
    caption: "Export-readiness, explained in one small booth",
    year: 2024,
    category: "Exhibition",
    w: 16,
    h: 10,
  },
  {
    ...
    src: frame(12),
    thumb: frame(12),
    alt: "Hands-on tunnel climate tuning during a workshop session, 2024",
    caption: "Tunnel climate tuning, hands on the dials",
    year: 2024,
    category: "Workshops",
    w: 4,
    h: 3,
  },
  {
    ...
    src: frame(15),
    thumb: frame(15),
    alt: "A finance panel discussing farm expansion loans on the main stage, 2024",
    caption: "NABARD on financing your next tunnel",
    year: 2024,
    category: "Awards",
    w: 2,
    h: 3,
...

  {
    ...
    src: frame(18),
    thumb: frame(18),
    alt: "India Mushroom Days' first keynote, livestreamed to forty partner farms, 2023",
    caption: "The first IMD keynote, livestreamed to 40 farms",
    year: 2023,
    category: "Keynotes",
    w: 4,
    h: 5,
  ...
  },
  {
    ...
    src: frame(21),
    thumb: frame(21),
    alt: "Early exhibition floor with a handful of founding suppliers, 2023",
    caption: "The exhibition floor, in its first and smallest form",
    year: 2023,
    category: "Exhibition",
    w: 1,
    h: 1,
  },
  {
    ...
    src: frame(24),
    thumb: frame(24),
    alt: "IMD's original hands-on tunnel climate workshop, 2023",
    caption: "Tunnel climate tuning, the original session",
    year: 2023,
    category: "Workshops",
    w: 16,
    h: 9,
  },
  {
    ...
    src: frame(27),
    thumb: frame(27),
    alt: "India Mushroom Days' first awards ceremony, held in a half-finished hall, 2023",
    caption: "IMD's first awards ceremony, half-built hall and all",
    year: 2023,
    category: "Awards",
    w: 3,
    h: 4,
  },
  {
    ...
    src: frame(30),
    thumb: frame(30),
    alt: "Early arrivals chatting before the very first session began, 2023",
    caption: "Early arrivals, before the first session even started",
    year: 2023,
    category: "Networking",
    w: 5,
    h: 4,
  },
  {
    ...
    src: frame(33),
    thumb: frame(33),
    alt: "Founding organisers addressing a small first-edition audience, 2023",
    caption: "Founding remarks to a room of eighty growers",
    year: 2023,
    category: "Keynotes",
    w: 9,
    h: 16,
  },
  {
    ...
    src: frame(36),
    thumb: frame(36),
    alt: "A single climate-control prototype on display at the first exhibition floor, 2023",
    caption: "One prototype, the seed of the exhibition floor",
    year: 2023,
    category: "Exhibition",
    w: 16,
    h: 10,
  },
  {
    ...
    src: frame(39),
    thumb: frame(39),
    alt: "Attendees taking notes during the first substrate workshop, 2023",
    caption: "Notebooks out for the first substrate session",
    year: 2023,
    category: "Workshops",
    w: 4,
    h: 3,
  },
  {
    ...
    src: frame(1),
    thumb: frame(1),
    alt: "A toast on the lawn marking the close of the first edition, 2023",
    caption: "Closing the first edition with a toast on the lawn",
    year: 2023,
    category: "Networking",
    w: 2,
    h: 3,
...
document.getElementById("yearFilters").addEventListener("click", (e) => {
  ...
  if (!b) return;
  document
    .querySelectorAll("#yearFilters .filt")
    .forEach((x) => x.classList.remove("active"));
  b.classList.add("active");
  filterYear = b.dataset.yr;
  renderGallery();
});
document.getElementById("catFilters").addEventListener("click", (e) => {
  ...
  if (!b) return;
  document
    .querySelectorAll("#catFilters .filt")
    .forEach((x) => x.classList.remove("active"));
  b.classList.add("active");
...
function handleFiles(fileList) {
  ...
  [...fileList].forEach((file) => {
    if (!ACCEPTED.includes(file.type)) {
      ...
      errors.push(
        `"${file.name}" is a ${ext} file — we can only add JPG, PNG, WEBP or GIF photos. Re-export it as one of those and try again.`,
      );
      return;
    }
    if (file.size > MAX_BYTES) {
      ...
      errors.push(
        `"${file.name}" is ${mb}MB — that's over our 8MB limit per photo. Compress it or export a smaller version and try again.`,
      );
      return;
    }
...
function renderErrors(errors) {
  errorsEl.innerHTML = errors
    .map((msg) => `<div class="upload-err">${escapeAttr(msg)}</div>`)
    .join("");
}

function renderPreviews() {
  previewGrid.innerHTML = pending
    .map(
      (p) => `
